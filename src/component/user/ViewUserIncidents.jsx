...
function ViewUserIncidentsPage() {
    ...
    useEffect(() => {
        const fetchIncidents = async () => {
            try {
                ...
                const response = await IncidentService.getUserIncidents(token, page, size, searchTerm); // Pass search term
...
export default ViewUserIncidentsPage;
